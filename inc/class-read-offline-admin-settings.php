...
class Read_Offline_Admin_Settings extends AdminPageFramework {
	...
	public function load_Read_Offline_Admin_Settings() {
		...
		add_filter( 'admin_title', [ $this, 'replyToModifyTitleTag' ], 10, 2 );
		add_filter( 'content_top_Read_Offline_Admin_Settings', [ $this, 'replyToInsertPluginTitle' ] );
		add_filter( 'content_top_Read_Offline_Admin_Settings', [ $this, 'replyToInsertDonationButton' ] );
		add_filter( 'style_common_Read_Offline_Admin_Settings', [ $this, 'replyToAddStyle' ] );
	...
	public function setUp() {
		...
		$this->addSettingFields(
			[
				...
				'description' => __(
                    ...
                    <pre>AddType application/epub+zip epub\nAddType application/x-mobipocket-ebook mobi<!--\nAddType application/vnd.openxmlformats-officedocument.wordprocessingml.document docx--></pre>",
					'read-offline'
				),
				'type'        => 'checkbox',
				'label'       => [
		...
		$this->addSettingFields(
			[  // Drop-down Lists with Mixed Types
			...
			[
				...
				'label'      => [
					...
					__( 'German DIN 476', 'read-offline' ) => [
						'4A0' => '4A0 (1682x2378 mm ; 66.22x93.62 in)',
						'2A0' => '2A0 (1189x1682 mm ; 46.81x66.22 in)',
					],

					__( 'Traditional "Loose" North American Paper Sizes', 'read-offline' ) => [
					...
					__( 'Other North American Paper Sizes', 'read-offline' ) => [
						'FOLIO'     => 'FOLIO, GOVERNMENTLEGAL (216x330 mm ; 8.50x13.00 in)',
						'EXECUTIVE' => 'EXECUTIVE, MONARCH (184x267 mm ; 7.25x10.50 in)',
					],
					__( 'Old Imperial English (some are still used in USA)', 'read-offline' ) => [
