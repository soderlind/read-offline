<?php
/**
 * Read_Offline_Settings_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'Read_Offline_Settings_AceCustomFieldType' ) ) :
class Read_Offline_Settings_AceCustomFieldType extends Read_Offline_Settings_AdminPageFramework_FieldType {
            ...
            jQuery().registerAPFCallback( {
                ...
                */
                added_repeatable_field: function( oCopied, sFieldType, sFieldTagID, iCallType ) {
                    ...
                    oCopied.closest( '.read-offline-field' ).nextAll().andSelf().each( function( iIndex ) {
