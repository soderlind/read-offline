<?php
/**
 * Read_Offline_AceCustomFieldType, for the  Admin Page Framework by Michael Uno, is written by Per Soderlind - http://soderlind.no
 */
if ( ! class_exists( 'Read_Offline_AceCustomFieldType' ) ) :
class Read_Offline_AceCustomFieldType extends Read_Offline_AdminPageFramework_FieldType {
