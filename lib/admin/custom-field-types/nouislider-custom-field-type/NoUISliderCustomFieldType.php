...
if ( ! class_exists( 'Read_Offline_NoUISliderCustomFieldType' ) ) :
/**
 ...
 */
class Read_Offline_NoUISliderCustomFieldType extends Read_Offline_AdminPageFramework_FieldType_text {
