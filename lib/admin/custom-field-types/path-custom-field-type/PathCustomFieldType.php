...
if ( ! class_exists( 'Read_Offline_PathCustomFieldType' ) ) :
/**
 ...
 */
class Read_Offline_PathCustomFieldType extends Read_Offline_AdminPageFramework_FieldType_image {
    ...
    public function getField( $aField ) {
        ...
        return
            $aField[ 'before_label' ]
            . "<div class='read-offline-input-label-container read-offline-input-container {$aField[ 'type' ]}-field'>" 
                . "<label for='{$aField[ 'input_id' ]}'>"
                    . $aField[ 'before_input' ]
                    . $this->getAOrB(
                        $aField[ 'label' ] && ! $aField[ 'repeatable' ],
                        "<span " . $this->getLabelContainerAttributes( $aField, 'read-offline-input-label-string' ) . ">" 
                            . $aField[ 'label' ] 
                        . "</span>",                        
                        ''                        
                    )
...
JAVASCRIPTS;
            ...
            return "<script type='text/javascript' class='read-offline-{$sType}-remove-button'>"
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
...
jQuery( document ).ready( function(){   
    //setRead_Offline_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}' );
});
JAVASCRIPTS;
                    
            return "<script type='text/javascript' class='read-offline-media-uploader-button'>" 
                    . '/* <![CDATA[ */'
                    . $_sScript 
                    . '/* ]]> */'
                . "</script>". PHP_EOL;
                ...
                return "<a " . $this->getAttributes( $_aAttributes ) . ">"
                        . $this->getAOrB( 
                            ...
                            $this->getAOrB(
                                ...
                                '',
                                __( 'Select Path', 'read-offline-field-type-pack' )
                            )
                        )
                    ."</a>";
