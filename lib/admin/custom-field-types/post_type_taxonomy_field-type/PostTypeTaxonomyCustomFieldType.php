 ...
 * @package     Read_Offline_Settings_AdminPageFramework
 */

if ( ! class_exists( 'Read_Offline_Settings_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class Read_Offline_Settings_PostTypeTaxonomyCustomFieldType extends Read_Offline_Settings_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.read-offline-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllRead_Offline_Settings_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.read-offline-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllRead_Offline_Settings_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.read-offline-field-post_type_taxonomy .read-offline-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.read-offline-field-post_type_taxonomy' );
    ...
    jQuery( '.read-offline-field-post_type_taxonomy .read-offline-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerRead_Offline_Settings_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.read-offline-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.read-offline-field-post_type_taxonomy .select_all_button_container, 
.read-offline-field-post_type_taxonomy .select_none_button_container
{
...
.read-offline-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'read-offline-loader' )
                    . "</label>"
                . "</div>";
