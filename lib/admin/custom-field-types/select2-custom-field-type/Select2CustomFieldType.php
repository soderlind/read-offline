...
if ( ! class_exists( 'Read_Offline_Select2CustomFieldType' ) ) :
/**
 ...
 */
class Read_Offline_Select2CustomFieldType extends Read_Offline_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.read-offline-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.read-offline-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.read-offline-select-label' )
                .children( 'label' )
                .children( '.read-offline-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set initial values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.read-offline-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.read-offline-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.read-offline-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.read-offline-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .read-offline-field-select2 > .read-offline-select-label > label > .read-offline-input-container {
    max-width: 84%;
}
