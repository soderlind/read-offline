...
if ( ! class_exists( 'Read_Offline_Settings_ToggleCustomFieldType' ) ) :
/**
 ...
 */
class Read_Offline_Settings_ToggleCustomFieldType extends Read_Offline_Settings_AdminPageFramework_FieldType_checkbox {
        ...
        return "jQuery( document ).ready( function(){
            ...
            jQuery( '.switch_toggle_buttons' ).each( function () {
                ...
                jQuery( this ).closest( '.read-offline-field' )
                    .children( '.read-offline-checkbox-container-toggle' )
                    .hide();
