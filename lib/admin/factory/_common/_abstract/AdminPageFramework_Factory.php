...
abstract class Read_Offline_Settings_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'Read_Offline_Settings_AdminPageFramework_Form_', 'oPageLoadInfo' => 'Read_Offline_Settings_AdminPageFramework_PageLoadInfo_', 'oResource' => 'Read_Offline_Settings_AdminPageFramework_Resource_', 'oHelpPane' => 'Read_Offline_Settings_AdminPageFramework_HelpPane_', 'oLink' => 'Read_Offline_Settings_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'Read_Offline_Settings_AdminPageFramework_Debug', 'oUtil' => 'Read_Offline_Settings_AdminPageFramework_FrameworkUtility', 'oMsg' => 'Read_Offline_Settings_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(Read_Offline_Settings_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return Read_Offline_Settings_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class Read_Offline_Settings_AdminPageFramework_Factory_Model extends Read_Offline_Settings_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class Read_Offline_Settings_AdminPageFramework_Factory_View extends Read_Offline_Settings_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new Read_Offline_Settings_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class Read_Offline_Settings_AdminPageFramework_Factory_Controller extends Read_Offline_Settings_AdminPageFramework_Factory_View {
...
abstract class Read_Offline_Settings_AdminPageFramework_Factory extends Read_Offline_Settings_AdminPageFramework_Factory_Controller {
}
