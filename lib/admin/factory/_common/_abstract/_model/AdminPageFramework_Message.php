...
class Read_Offline_Settings_AdminPageFramework_Message {
    ...
    public static function getInstance($sTextDomain = 'read-offline') {
        $_oInstance = isset(self::$_aInstancesByTextDomain[$sTextDomain]) && (self::$_aInstancesByTextDomain[$sTextDomain] instanceof Read_Offline_Settings_AdminPageFramework_Message) ? self::$_aInstancesByTextDomain[$sTextDomain] : new Read_Offline_Settings_AdminPageFramework_Message($sTextDomain);
    ...
    private function __doDummy() {
        ...
        __('Field Arguments', 'read-offline');
        ...
        __('Section Arguments', 'read-offline');
