...
abstract class Read_Offline_AdminPageFramework_Property_Base extends Read_Offline_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aRead_Offline_AdminPageFramework'])) {
            $GLOBALS['aRead_Offline_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => Read_Offline_AdminPageFramework_Registry::NAME, 'sURI' => Read_Offline_AdminPageFramework_Registry::URI, 'sScriptName' => Read_Offline_AdminPageFramework_Registry::NAME, 'sLibraryName' => Read_Offline_AdminPageFramework_Registry::NAME, 'sLibraryURI' => Read_Offline_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => Read_Offline_AdminPageFramework_Registry::getVersion(), 'sDescription' => Read_Offline_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => Read_Offline_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => Read_Offline_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => Read_Offline_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => Read_Offline_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
