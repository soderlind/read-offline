...
abstract class Read_Offline_Settings_AdminPageFramework_Property_Base extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    ...
    private function ___setProperties($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'read-offline' : $sTextDomain;
    ...
    private function ___setGlobals() {
        if (!isset($GLOBALS['aRead_Offline_Settings_AdminPageFramework'])) {
            $GLOBALS['aRead_Offline_Settings_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => Read_Offline_Settings_AdminPageFramework_Registry::NAME, 'sURI' => Read_Offline_Settings_AdminPageFramework_Registry::URI, 'sScriptName' => Read_Offline_Settings_AdminPageFramework_Registry::NAME, 'sLibraryName' => Read_Offline_Settings_AdminPageFramework_Registry::NAME, 'sLibraryURI' => Read_Offline_Settings_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => Read_Offline_Settings_AdminPageFramework_Registry::getVersion(), 'sDescription' => Read_Offline_Settings_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => Read_Offline_Settings_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => Read_Offline_Settings_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => Read_Offline_Settings_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => Read_Offline_Settings_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new Read_Offline_Settings_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
