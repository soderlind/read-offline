...
abstract class Read_Offline_Settings_AdminPageFramework_PageLoadInfo_Base extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    public $oProp;
    public $oMsg;
