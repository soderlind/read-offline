...
abstract class Read_Offline_Settings_AdminPageFramework_Form_Utility extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    ...
    static public function getFieldsetReformattedBySubFieldIndex($aFieldset, $iSubFieldIndex, $bHasSubFields, $aParentFieldset) {
        ...
        $_oFieldsetFormatter = new Read_Offline_Settings_AdminPageFramework_Form_Model___Format_Fieldset($aFieldset, $aFieldset['_structure_type'], $aFieldset['capability'], ( integer )$iSubFieldIndex + 1, $aFieldset['_subsection_index'], $aFieldset['_is_section_repeatable'], $aFieldset['_caller_object']);
        $aFieldset = $_oFieldsetFormatter->get();
        $_oFieldsetOutputFormatter = new Read_Offline_Settings_AdminPageFramework_Form_Model___Format_FieldsetOutput($aFieldset, $aFieldset['_section_index'], $_oCallerForm->aFieldTypeDefinitions);
...
abstract class Read_Offline_Settings_AdminPageFramework_Form_Base extends Read_Offline_Settings_AdminPageFramework_Form_Utility {
...
class Read_Offline_Settings_AdminPageFramework_Form_Model extends Read_Offline_Settings_AdminPageFramework_Form_Base {
    ...
    public function getSortedInputs(array $aFormInputs) {
        ...
        $_oInputSorter = new Read_Offline_Settings_AdminPageFramework_Form_Model___Modifier_SortInput($aFormInputs, $_aDynamicFieldAddressKeys);
    ...
    public function dropRepeatableElements(array $aSubject) {
        $_oFilterRepeatableElements = new Read_Offline_Settings_AdminPageFramework_Form_Model___Modifier_FilterRepeatableElements($aSubject, $this->getElementAsArray($_POST, '__repeatable_elements_' . $this->aArguments['structure_type']));
    ...
    public function _replyToRegisterFormItems() {
        ...
        $_oFieldResources = new Read_Offline_Settings_AdminPageFramework_Form_Model___SetFieldResources($this->aArguments, $this->aFieldsets, self::$_aResources, $this->aFieldTypeDefinitions, $this->aCallbacks);
    ...
    private function _setSiteWideFieldTypeDefinitions() {
        ...
        $_oBuiltInFieldTypeDefinitions = new Read_Offline_Settings_AdminPageFramework_Form_Model___BuiltInFieldTypeDefinitions('admin_page_framework', $this->oMsg);
    ...
    public function getDefaultFormValues() {
        $_oDefaultValues = new Read_Offline_Settings_AdminPageFramework_Form_Model___DefaultValues($this->aFieldsets);
        return $_oDefaultValues->get();
    }
    protected function _formatElementDefinitions(array $aSavedData) {
        $_oSectionsetsFormatter = new Read_Offline_Settings_AdminPageFramework_Form_Model___FormatSectionsets($this->aSectionsets, $this->aArguments['structure_type'], $this->sCapability, $this->aCallbacks, $this);
        $this->aSectionsets = $_oSectionsetsFormatter->get();
        $_oFieldsetsFormatter = new Read_Offline_Settings_AdminPageFramework_Form_Model___FormatFieldsets($this->aFieldsets, $this->aSectionsets, $this->aArguments['structure_type'], $this->aSavedData, $this->sCapability, $this->aCallbacks, $this);
...
class Read_Offline_Settings_AdminPageFramework_Form_View extends Read_Offline_Settings_AdminPageFramework_Form_Model {
    public function __construct() {
        parent::__construct();
        new Read_Offline_Settings_AdminPageFramework_Form_View__Resource($this);
    }
    public function get() {
...
class Read_Offline_Settings_AdminPageFramework_Form_Controller extends Read_Offline_Settings_AdminPageFramework_Form_View {
...
class Read_Offline_Settings_AdminPageFramework_Form extends Read_Offline_Settings_AdminPageFramework_Form_Controller {
    ...
    public $oFieldError;
    public $oLastInputs;
    public $aSubClasses = array('submit_notice' => 'Read_Offline_Settings_AdminPageFramework_Form___SubmitNotice', 'field_error' => 'Read_Offline_Settings_AdminPageFramework_Form___FieldError', 'last_input' => 'Read_Offline_Settings_AdminPageFramework_Form_Model___LastInput', 'message' => 'Read_Offline_Settings_AdminPageFramework_Message',);
    public function __construct() {
