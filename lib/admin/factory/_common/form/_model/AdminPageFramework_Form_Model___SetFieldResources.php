...
class Read_Offline_Settings_AdminPageFramework_Form_Model___SetFieldResources extends Read_Offline_Settings_AdminPageFramework_Form_Base {
    ...
    private function ___setCommon() {
        ...
        new Read_Offline_Settings_AdminPageFramework_Form_View___Script_RegisterCallback;
        $this->___setCommonFormInternalCSSRules();
    }
    private function ___setCommonFormInternalCSSRules() {
        $_aClassNames = array('Read_Offline_Settings_AdminPageFramework_Form_View___CSS_Form', 'Read_Offline_Settings_AdminPageFramework_Form_View___CSS_Field', 'Read_Offline_Settings_AdminPageFramework_Form_View___CSS_Section', 'Read_Offline_Settings_AdminPageFramework_Form_View___CSS_CollapsibleSection', 'Read_Offline_Settings_AdminPageFramework_Form_View___CSS_FieldError', 'Read_Offline_Settings_AdminPageFramework_Form_View___CSS_ToolTip',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
            $this->aResources['internal_styles'][] = $_oCSS->get();
        }
        $_aClassNamesForIE = array('Read_Offline_Settings_AdminPageFramework_Form_View___CSS_CollapsibleSectionIE',);
        foreach ($_aClassNames as $_sClassName) {
            $_oCSS = new $_sClassName;
    ...
    private function ___setFieldResourcesByFieldTypeDefinition($aFieldset, $_sFieldtype, $_aFieldTypeDefinition) {
        ...
        new Read_Offline_Settings_AdminPageFramework_Form_Model___FieldTypeRegistration($_aFieldTypeDefinition, $this->aArguments['structure_type']);
        $_oFieldTypeResources = new Read_Offline_Settings_AdminPageFramework_Form_Model___FieldTypeResource($_aFieldTypeDefinition, $this->aResources);
