...
class Read_Offline_AdminPageFramework_Form_Model___FormatSectionset extends Read_Offline_AdminPageFramework_Form_Utility {
    ...
    public function get() {
        ...
        $_oCollapsibleArgumentFormatter = new Read_Offline_AdminPageFramework_Form_Model___Format_CollapsibleSection($_aSectionset['collapsible'], $_aSectionset['title']);
