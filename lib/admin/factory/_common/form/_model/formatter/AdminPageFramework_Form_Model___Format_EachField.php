...
abstract class Read_Offline_Settings_AdminPageFramework_Form_Model___Format_FormField_Base extends Read_Offline_Settings_AdminPageFramework_Form_Utility {
}
class Read_Offline_Settings_AdminPageFramework_Form_Model___Format_EachField extends Read_Offline_Settings_AdminPageFramework_Form_Model___Format_FormField_Base {
    ...
    public function get() {
        ...
        $_oInputTagIDGenerator = new Read_Offline_Settings_AdminPageFramework_Form_View___Generate_FieldInputID($_aField, $this->isIndex, $this->aCallbacks['hfID']);
        $_aField['input_id'] = $_oInputTagIDGenerator->get();
        $_oFieldInputNameGenerator = new Read_Offline_Settings_AdminPageFramework_Form_View___Generate_FieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputName']);
        $_aField['_input_name'] = $_oFieldInputNameGenerator->get();
        $_oFieldFlatInputName = new Read_Offline_Settings_AdminPageFramework_Form_View___Generate_FlatFieldInputName($_aField, $this->getAOrB($_aField['_is_multiple_fields'], $this->isIndex, ''), $this->aCallbacks['hfInputNameFlat']);
        ...
        $_aField['_field_object'] = new Read_Offline_Settings_AdminPageFramework_ArrayHandler($_aField);
        return $_aField;
    }
}
