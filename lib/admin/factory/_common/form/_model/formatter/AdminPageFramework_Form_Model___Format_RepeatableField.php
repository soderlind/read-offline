...
class Read_Offline_AdminPageFramework_Form_Model___Format_RepeatableSection extends Read_Offline_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : Read_Offline_AdminPageFramework_Message::getInstance();
    }
    public function get() {
    ...
    class Read_Offline_AdminPageFramework_Form_Model___Format_RepeatableField extends Read_Offline_AdminPageFramework_Form_Model___Format_RepeatableSection {
        protected function _getDefaultMessage() {
