...
class Read_Offline_Settings_AdminPageFramework_Form_Model___Modifier_SortInput extends Read_Offline_Settings_AdminPageFramework_Form_Model___Modifier_Base {
    public $aInput = array();
