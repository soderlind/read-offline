...
class Read_Offline_Settings_AdminPageFramework_Form_View___DebugInfo extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='read-offline-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
