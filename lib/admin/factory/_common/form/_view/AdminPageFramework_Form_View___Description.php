...
class Read_Offline_Settings_AdminPageFramework_Form_View___Description extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    public $aDescriptions = array();
    public $sClassAttribute = 'read-offline-form-element-description';
