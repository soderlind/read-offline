...
abstract class Read_Offline_Settings_AdminPageFramework_Form_View___Attribute_Base extends Read_Offline_Settings_AdminPageFramework_Form_Utility {
    public $sContext = '';
...
abstract class Read_Offline_Settings_AdminPageFramework_Form_View___Attribute_FieldContainer_Base extends Read_Offline_Settings_AdminPageFramework_Form_View___Attribute_Base {
    protected function _getFormattedAttributes() {
...
class Read_Offline_Settings_AdminPageFramework_Form_View___Attribute_Field extends Read_Offline_Settings_AdminPageFramework_Form_View___Attribute_FieldContainer_Base {
    public $sContext = 'field';
    protected function _getAttributes() {
        $_sFieldTypeSelector = $this->getAOrB($this->aArguments['type'], " read-offline-field-{$this->aArguments['type']}", '');
        ...
        return array('id' => $this->aArguments['_field_container_id'], 'data-type' => $this->aArguments['type'], 'class' => "read-offline-field{$_sFieldTypeSelector}{$_sNestedFieldSelector}{$_sMixedFieldSelector}{$_sChildFieldSelector}" . $this->getAOrB($this->aArguments['attributes']['disabled'], ' disabled', '') . $this->getAOrB($this->aArguments['_is_sub_field'], ' read-offline-subfield', ''));
    }
}
