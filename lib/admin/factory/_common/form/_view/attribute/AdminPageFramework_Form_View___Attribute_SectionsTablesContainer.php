...
class Read_Offline_AdminPageFramework_Form_View___Attribute_SectionsTablesContainer extends Read_Offline_AdminPageFramework_Form_View___Attribute_Base {
    ...
    private function _getDynamicElementArguments($aSectionset) {
        ...
        $_oSectionNameGenerator = new Read_Offline_AdminPageFramework_Form_View___Generate_SectionName($aSectionset, $aSectionset['_caller_object']->aCallbacks['hfSectionName']);
