...
class Read_Offline_Settings_AdminPageFramework_Form_View___Generate_FieldTagID extends Read_Offline_Settings_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class Read_Offline_Settings_AdminPageFramework_Form_View___Generate_FieldInputID extends Read_Offline_Settings_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
