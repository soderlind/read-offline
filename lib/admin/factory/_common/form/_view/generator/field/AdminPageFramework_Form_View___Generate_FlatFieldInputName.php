...
class Read_Offline_AdminPageFramework_Form_View___Generate_FieldInputName extends Read_Offline_AdminPageFramework_Form_View___Generate_FlatFieldName {
    public $sIndex = '';
    ...
    class Read_Offline_AdminPageFramework_Form_View___Generate_FlatFieldInputName extends Read_Offline_AdminPageFramework_Form_View___Generate_FieldInputName {
        public function get() {
            $_sIndex = $this->getAOrB('0' !== $this->sIndex && empty($this->sIndex), '', "|{$this->sIndex}");
