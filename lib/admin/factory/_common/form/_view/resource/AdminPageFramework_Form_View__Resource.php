...
class Read_Offline_Settings_AdminPageFramework_Form_View__Resource extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _setHooks() {
        ...
        new Read_Offline_Settings_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'wp_head');
    }
    private function _setAdminHooks() {
        ...
        new Read_Offline_Settings_AdminPageFramework_Form_View__Resource__Head($this->oForm, 'admin_head');
    }
