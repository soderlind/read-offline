...
class Read_Offline_AdminPageFramework_Form_View__Resource__Head extends Read_Offline_AdminPageFramework_FrameworkUtility {
    public $oForm;
    ...
    private function _getInternalCSS() {
        $_oLoadingCSS = new Read_Offline_AdminPageFramework_Form_View___CSS_Loading;
