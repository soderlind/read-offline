...
class Read_Offline_Settings_AdminPageFramework_Form_View___Script_CollapsibleSection extends Read_Offline_Settings_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
    ...
    jQuery( document ).ready( function() {
        jQuery( this ).initializeRead_Offline_Settings_AdminPageFrameworkCollapsibleSections();
    });              
    ...
    jQuery( document ).bind( 'read-offline_saved_widget', function( event, oWidget ){
        jQuery( oWidget ).initializeRead_Offline_Settings_AdminPageFrameworkCollapsibleSections();
    });    
    
    $.fn.initializeRead_Offline_Settings_AdminPageFrameworkCollapsibleSections = function() {
        ...
        jQuery( this ).find( '.read-offline-collapsible-sections-title, .read-offline-collapsible-section-title' )
            .enableRead_Offline_Settings_AdminPageFrameworkCollapsibleButton();
     ...
     */
    $.fn.enableRead_Offline_Settings_AdminPageFrameworkCollapsibleButton = function() {
