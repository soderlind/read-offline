...
class Read_Offline_Settings_AdminPageFramework_Form_View___Script_RegisterCallback extends Read_Offline_Settings_AdminPageFramework_Form_View___Script_Base {
    static public function getScript() {
        return <<<JAVASCRIPTS
(function ( $ ) {
            
    // Callback containers.
    $.fn.aRead_Offline_Settings_AdminPageFrameworkAddRepeatableFieldCallbacks        = [];            
    $.fn.aRead_Offline_Settings_AdminPageFrameworkRepeatFieldCallbacks               = [];    // 3.8.8+
    $.fn.aRead_Offline_Settings_AdminPageFrameworkRemoveRepeatableFieldCallbacks     = [];
    $.fn.aRead_Offline_Settings_AdminPageFrameworkSortedFieldsCallbacks              = [];            
    $.fn.aRead_Offline_Settings_AdminPageFrameworkStoppedSortingFieldsCallbacks      = [];
    $.fn.aRead_Offline_Settings_AdminPageFrameworkAddedWidgetCallbacks               = [];
    $.fn.aRead_Offline_Settings_AdminPageFrameworkStoppedSortingSectionsCallbacks    = [];    // 3.8.0+
    ...
    $( document ).bind( 'read-offline_added_repeatable_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){          
        ...
        $.each( $.fn.aRead_Offline_Settings_AdminPageFrameworkAddRepeatableFieldCallbacks, function( iIndex, aCallback ) {
            ...
            if ( -1 === $.inArray( sFieldType, [ '_nested', 'inline_mixed' ] ) ) {                
                console.warn( 'Admin Page Framework (' + sFieldType + ' field type): The `added_repeatable_field` callback argument for the `registerRead_Offline_Settings_AdminPageFrameworkCallbacks` method is deprecated. Use `repeated_field` instead.' );
            }
    ...
    $( document ).bind( 'read-offline_repeated_field', function( oEvent, iCallType, oModelContainer ){
        ...
        $.each( $.fn.aRead_Offline_Settings_AdminPageFrameworkRepeatFieldCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ]; // '_nested', 'inline_mixed' are built-in
            if ( -1 !== $.inArray( sFieldType, [ '_nested', 'inline_mixed' ] ) ) {
                return true;    // continue
    ...
    $( document ).bind( 'read-offline_stopped_sorting_sections', function( oEvent ){  
        ...
        var _oThisNode = jQuery( oEvent.target );
        $.each( $.fn.aRead_Offline_Settings_AdminPageFrameworkStoppedSortingSectionsCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
    ...
    /* $( document ).bind( 'read-offline_removed_field', function( oEvent, sFieldType, sID, iCallType, iSectionIndex, iFieldIndex ){
        var _oThisNode = jQuery( oEvent.target );
        $.each( $.fn.aRead_Offline_Settings_AdminPageFrameworkRemoveRepeatableFieldCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ];       
            if ( 2 < _aFieldTypes.length && -1 === $.inArray( sFieldType, _aFieldTypes ) ) {
                return true; // continue
    ...
    $.fn.callBackSortedFields = function( sFieldType, sID, iCallType ) {
        var oThisNode = this;
        $.fn.aRead_Offline_Settings_AdminPageFrameworkSortedFieldsCallbacks.forEach( function( aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
    ...
    $.fn.callBackStoppedSortingFields = function( sFieldType, sID, iCallType ) {
        var oThisNode = this;
        $.fn.aRead_Offline_Settings_AdminPageFrameworkStoppedSortingFieldsCallbacks.forEach( function( aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ]; // '_nested', 'inline_mixed' are built-in
            if ( 2 < _aFieldTypes.length && -1 === $.inArray( sFieldType, _aFieldTypes ) ) {
                return true; // continue
    ...
    $( document ).bind( 'read-offline_saved_widget', function( event, oWidget ){
        $.each( $.fn.aRead_Offline_Settings_AdminPageFrameworkAddedWidgetCallbacks, function( iIndex, aCallback ) {
            var _hfCallback  = aCallback[ 0 ];
            var _aFieldTypes = aCallback[ 1 ];
            if ( ! $.isFunction( _hfCallback ) ) { 
                return true;    // continue
     ...
     */
    $.fn.registerRead_Offline_Settings_AdminPageFrameworkCallbacks = function( oCallbacks, aFieldTypeSlugs ) {
        ...
        $.fn.aRead_Offline_Settings_AdminPageFrameworkAddRepeatableFieldCallbacks.push( 
            [ oCallbacks.added_repeatable_field, aFieldTypeSlugs ]
        );

        $.fn.aRead_Offline_Settings_AdminPageFrameworkRepeatFieldCallbacks.push(  // 3.8.8+
            [ oCallbacks.repeated_field, aFieldTypeSlugs ]
        );        
        $.fn.aRead_Offline_Settings_AdminPageFrameworkRemoveRepeatableFieldCallbacks.push( 
            [ oCallbacks.removed_repeatable_field, aFieldTypeSlugs ]
        );
        $.fn.aRead_Offline_Settings_AdminPageFrameworkSortedFieldsCallbacks.push( 
            [ oCallbacks.sorted_fields, aFieldTypeSlugs ]
        );
        $.fn.aRead_Offline_Settings_AdminPageFrameworkStoppedSortingFieldsCallbacks.push( 
            [ oCallbacks.stopped_sorting_fields, aFieldTypeSlugs ]
        );
        $.fn.aRead_Offline_Settings_AdminPageFrameworkAddedWidgetCallbacks.push( 
            [ oCallbacks.saved_widget, aFieldTypeSlugs ]
        );

        // 3.8.0
        $.fn.aRead_Offline_Settings_AdminPageFrameworkStoppedSortingSectionsCallbacks.push( 
            [ oCallbacks.stopped_sorting_sections, aFieldTypeSlugs ]
        );        

    };
    /**
     * An alias of the `registerRead_Offline_Settings_AdminPageFrameworkCalbacks()` method.
    ...
    $.fn.registerAPFCallback = function( oCallbacks, aFieldTypeSlugs ) {
        $.fn.registerRead_Offline_Settings_AdminPageFrameworkCallbacks( oCallbacks, aFieldTypeSlugs );
    }
