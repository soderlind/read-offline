...
class Read_Offline_AdminPageFramework_Form_View___Script_RepeatableSection extends Read_Offline_AdminPageFramework_Form_View___Script_Base {
...
( function( $ ) {
     ...
     */
    $.fn.updateRead_Offline_AdminPageFrameworkRepeatableSections = function( aSettings ) {
        ...
        if ( ! $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions ) {
            $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions = [];
        }
        if ( ! $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions.hasOwnProperty( _sSectionsContainerID ) ) {
            $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ _sSectionsContainerID ] = $.extend(
                {    
        ...
        var _aOptions = $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ _sSectionsContainerID ];
        ...
        $( _oThis ).find( '.repeatable-section-add-button' ).click( function() {
            ...
            $( this ).addRead_Offline_AdminPageFrameworkRepeatableSection();
        ...
        $( _oThis ).find( '.repeatable-section-remove-button' ).click( function() {
            $( this ).removeRead_Offline_AdminPageFrameworkRepeatableSection();
            return false; // will not click after that
        });     
        ...
        if ( _aOptions[ 'min' ] > 0 && _nCurrentSectionCount > 0 ) {
            if ( ( _aOptions[ 'min' ] - _nCurrentSectionCount ) > 0 ) {     
                $( '#' + _sSectionID ).addRead_Offline_AdminPageFrameworkRepeatableSection( _sSectionID );  
            }
        }
     ...
     */    
    $.fn.addRead_Offline_AdminPageFrameworkRepeatableSection = function( sSectionContainerID ) {
        ...
        var _iFadein                = $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'fadein' ];
        var _iFadeout               = $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'fadeout' ];
        var _bPreserveValues        = $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'preserve_values' ];
        
        // If the set maximum number of sections already exists, do not add.
        var _sMaxNumberOfSections   = $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'max' ];
        ...
        if( 'function' === typeof nodeNewSection.enableRead_Offline_AdminPageFrameworkCollapsibleButton ){ 
            nodeNewSection.find( '.read-offline-collapsible-sections-title, .read-offline-collapsible-section-title' ).enableRead_Offline_AdminPageFrameworkCollapsibleButton();
        }
        ...
        $( nodeNewSection ).find( '.read-offline-field' ).each( function( iFieldIndex ) {
            ...
            $( this ).updateRead_Offline_AdminPageFrameworkRepeatableFields();
        ...
        nodeNewSection.updateRead_Offline_AdminPageFrameworkRepeatableSections();    
        
        // Rebind sortable fields - iterate sortable fields containers.
        nodeNewSection.find( '.read-offline-fields.sortable' ).each( function() {
            $( this ).enableRead_Offline_AdminPageFrameworkSortableFields();
        });
        ...
        var _incrementAttributes = function( oElement, iSectionsCount, oSectionsContainer ) {
            ...
            $( oElement ).find( 'tr.read-offline-fieldrow, .read-offline-fieldset, .read-offline-fields, .read-offline-field, table.form-table, input,textarea,select,option' )
                .incrementAttribute( 
                    'id', 
                    iSectionsCount,
                    _sSectionIDModel
     ...
     */
    $.fn.removeRead_Offline_AdminPageFrameworkRepeatableSection = function() {
        ...
        var _sMinNumberOfSections = $.fn.aRead_Offline_AdminPageFrameworkRepeatableSectionsOptions[ sSectionsContainerID ][ 'min' ];
...
JAVASCRIPTS;
    ...
    static public function getEnabler($sContainerTagID, $iSectionCount, $asArguments, $oMsg) {
        ...
        new self($oMsg);
        $_oFormatter = new Read_Offline_AdminPageFramework_Form_Model___Format_RepeatableSection($asArguments, $oMsg);
...
jQuery( document ).ready( function() {
    ...
    // Update the fields     
    jQuery( '#{$sContainerTagID}' ).updateRead_Offline_AdminPageFrameworkRepeatableSections( $_aJSArray ); 
});            
JAVASCRIPTS;
    ...
    static private function ___getRepeatableSectionButtons($_aArguments, $oMsg, $sContainerTagID, $iSectionCount) {
        ...
        return "<div class='read-offline-repeatable-section-buttons-outer-container'>" . "<div " . self::___getContainerAttributes($_aArguments, $oMsg) . ' >' . "<a " . self::___getRemoveButtonAttributes($sContainerTagID, $oMsg, $iSectionCount) . ">" . $_sIconRemove . "</a>" . "<a " . self::___getAddButtonAttributes($sContainerTagID, $oMsg, $_aArguments) . ">" . $_sIconAdd . "</a>" . "</div>" . "</div>" . Read_Offline_AdminPageFramework_Form_Utility::getModalForDisabledRepeatableElement('repeatable_section_disabled_' . $sContainerTagID, $_aArguments['disabled']);
    }
