...
class Read_Offline_Settings_AdminPageFramework_Form_View___Script_SectionTab extends Read_Offline_Settings_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.read-offline-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='read-offline-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
