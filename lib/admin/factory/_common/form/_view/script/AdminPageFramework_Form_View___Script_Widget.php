...
class Read_Offline_Settings_AdminPageFramework_Form_View___Script_Widget extends Read_Offline_Settings_AdminPageFramework_Form_View___Script_Base {
    ...
    $( document ).ready( function() {
        ...
        $( document ).ajaxComplete( function( event, XMLHttpRequest, ajaxOptions ) {
            ...
            if( _aRequest.action && ( 'save-widget' === _aRequest.action ) ) {
                ...
                if ( $( _oWidget ).find( '.read-offline-sectionset' ).length <= 0 ) { 
                    return; 
                }   
