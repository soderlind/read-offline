...
class Read_Offline_Settings_AdminPageFramework_Form_View___Section_Base extends Read_Offline_Settings_AdminPageFramework_Form_Base {
    ...
    public function getFieldsetOutput($aFieldset) {
        ...
        $_oFieldset = new Read_Offline_Settings_AdminPageFramework_Form_View___Fieldset($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
        $_sFieldOutput = $_oFieldset->get();
        return $_sFieldOutput;
    }
}
class Read_Offline_Settings_AdminPageFramework_Form_View___SectionTitle extends Read_Offline_Settings_AdminPageFramework_Form_View___Section_Base {
    ...
    private function _getToolTip($_aSectionset) {
        ...
        $_oToolTip = new Read_Offline_Settings_AdminPageFramework_Form_View___ToolTip($_aSectionset['tip'], $_sSectionTitleTagID);
    ...
    private function _getDebugInfo($aSectionset) {
        ...
        $_oToolTip = new Read_Offline_Settings_AdminPageFramework_Form_View___ToolTip(array('title' => $this->oMsg->get('section_arguments'), 'dash-icon' => 'dashicons-info', 'icon_alt_text' => '[' . $this->oMsg->get('debug') . ' ]', 'content' => Read_Offline_Settings_AdminPageFramework_Debug::getDetails($aSectionset) . '<span class="read-offline-info">' . $this->getFrameworkNameVersion() . '  (' . $this->oMsg->get('debug_info_will_be_disabled') . ')' . '</span>', 'attributes' => array('container' => array('class' => 'debug-info-field-arguments'),)), $aSectionset['_section_path'] . '_debug');
        return $_oToolTip->get();
    }
    ...
    private function _getFieldsetsInSectionTitleArea(array $aFieldsets, $iSectionIndex, $aFieldTypeDefinitions) {
        ...
        foreach ($aFieldsets as $_aFieldset) {
            ...
            $_oFieldsetOutputFormatter = new Read_Offline_Settings_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $iSectionIndex, $aFieldTypeDefinitions);
...
class Read_Offline_Settings_AdminPageFramework_Form_View___CollapsibleSectionTitle extends Read_Offline_Settings_AdminPageFramework_Form_View___SectionTitle {
    ...
    protected function _getCollapsibleSectionsEnablerScript() {
        ...
        self::$_bLoaded = true;
        new Read_Offline_Settings_AdminPageFramework_Form_View___Script_CollapsibleSection($this->oMsg);
    }
}
