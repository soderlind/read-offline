...
class Read_Offline_AdminPageFramework_Form_View___FieldsetTableRow extends Read_Offline_AdminPageFramework_Form_View___Section_Base {
    ...
    public function get() {
        ...
        $_oFieldrowAttribute = new Read_Offline_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset, array('id' => 'fieldrow-' . $aFieldset['tag_id'], 'valign' => 'top', 'class' => 'read-offline-fieldrow',));
    ...
    protected function _getFieldByContainer(array $aFieldset, array $aOpenCloseTags) {
        ...
        $_oFieldTitle = new Read_Offline_AdminPageFramework_Form_View___FieldTitle($aFieldset, '', $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_aOutput = array();
    ...
    class Read_Offline_AdminPageFramework_Form_View___FieldsetRow extends Read_Offline_AdminPageFramework_Form_View___FieldsetTableRow {
        public $aFieldset = array();
        public $aSavedData = array();
        public $aFieldErrors = array();
        public $aFieldTypeDefinitions = array();
        ...
        public function get() {
            ...
            $_oFieldrowAttribute = new Read_Offline_AdminPageFramework_Form_View___Attribute_Fieldrow($aFieldset);
