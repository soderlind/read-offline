...
class Read_Offline_Settings_AdminPageFramework_Form_View___FieldsetRows extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    ...
    public function get($bTableRow = true) {
        ...
        foreach ($this->aFieldsetsPerSection as $_aFieldset) {
            $_oFieldsetOutputFormatter = new Read_Offline_Settings_AdminPageFramework_Form_Model___Format_FieldsetOutput($_aFieldset, $this->iSectionIndex, $this->aFieldTypeDefinitions);
    ...
    private function _getFieldsetRow($aFieldset) {
        $_oFieldsetRow = new Read_Offline_Settings_AdminPageFramework_Form_View___FieldsetTableRow($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        return $_oFieldsetRow->get();
    }
    private function _getFieldset($aFieldset) {
        $_oFieldsetRow = new Read_Offline_Settings_AdminPageFramework_Form_View___FieldsetRow($aFieldset, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        return $_oFieldsetRow->get();
    }
}
