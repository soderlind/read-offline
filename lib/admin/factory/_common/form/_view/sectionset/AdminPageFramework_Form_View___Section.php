...
class Read_Offline_AdminPageFramework_Form_View___Section extends Read_Offline_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        $_oTableCaption = new Read_Offline_AdminPageFramework_Form_View___SectionCaption($this->aSectionset, $_iSectionIndex, $this->aFieldsetsPerSection, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
        $_oSectionTableAttributes = new Read_Offline_AdminPageFramework_Form_View___Attribute_SectionTable($this->aSectionset);
        $_oSectionTableBodyAttributes = new Read_Offline_AdminPageFramework_Form_View___Attribute_SectionTableBody($this->aSectionset);
        $_aOutput = array();
        ...
        $_oSectionTableContainerAttributes = new Read_Offline_AdminPageFramework_Form_View___Attribute_SectionTableContainer($this->aSectionset);
    ...
    private function _getSectionContent($_iSectionIndex) {
        ...
        $_oFieldsets = new Read_Offline_AdminPageFramework_Form_View___FieldsetRows($this->aFieldsetsPerSection, $_iSectionIndex, $this->aSavedData, $this->aFieldErrors, $this->aFieldTypeDefinitions, $this->aCallbacks, $this->oMsg);
    ...
    private function _getCustomSectionContent() {
        ...
        $_oFormTables = new Read_Offline_AdminPageFramework_Form_View___Sectionsets($_aArguments, $_aStructure, $this->aSavedData, $this->aFieldErrors, $this->aCallbacks, $this->oMsg);
