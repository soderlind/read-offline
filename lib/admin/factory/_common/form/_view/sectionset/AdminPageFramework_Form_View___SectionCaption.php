...
class Read_Offline_AdminPageFramework_Form_View___SectionCaption extends Read_Offline_AdminPageFramework_FrameworkUtility {
    ...
    private function _getCaptionTitle($aSectionset, $iSectionIndex, $aFieldsets, $aFieldTypeDefinitions) {
        $_oSectionTitle = new Read_Offline_AdminPageFramework_Form_View___SectionTitle(array('title' => $aSectionset['title'], 'tag' => 'h3', 'section_index' => $iSectionIndex, 'sectionset' => $aSectionset,), $aFieldsets, $this->aSavedData, $this->aFieldErrors, $aFieldTypeDefinitions, $this->oMsg, $this->aCallbacks);
    ...
    private function _getCaptionDescription($aSectionset, $hfSectionCallback) {
        ...
        $_oSectionDescription = new Read_Offline_AdminPageFramework_Form_View___Description($aSectionset['description'], 'read-offline-section-description');
