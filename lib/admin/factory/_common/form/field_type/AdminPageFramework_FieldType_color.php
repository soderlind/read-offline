...
abstract class Read_Offline_Settings_AdminPageFramework_FieldType_Base extends Read_Offline_Settings_AdminPageFramework_Form_Utility {
    ...
    public function __construct($asClassName = 'admin_page_framework', $asFieldTypeSlug = null, $oMsg = null, $bAutoRegister = true) {
        ...
        $this->oMsg = $oMsg ? $oMsg : Read_Offline_Settings_AdminPageFramework_Message::getInstance();
        if ($bAutoRegister) {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new Read_Offline_Settings_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new Read_Offline_Settings_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class Read_Offline_Settings_AdminPageFramework_FieldType extends Read_Offline_Settings_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class Read_Offline_Settings_AdminPageFramework_FieldType_color extends Read_Offline_Settings_AdminPageFramework_FieldType {
    ...
    protected function getScripts() {
        ...
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerRead_Offline_Settings_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    jQuery().registerRead_Offline_Settings_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerRead_Offline_Settings_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
jQuery( document ).ready( function(){
    registerRead_Offline_Settings_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
