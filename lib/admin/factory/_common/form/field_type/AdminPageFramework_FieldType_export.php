...
class Read_Offline_AdminPageFramework_FieldType_submit extends Read_Offline_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".read-offline-field input[type='submit'] {margin-bottom: 0.5em;}.read-offline-field-submit .submit-confirm-container {display: inline-block;margin-left: 1em;vertical-align: middle;}.read-offline-field-submit .field-error.submit-confirmation-warning {float: none;}";
    }
    protected function getScripts() {
        return <<<JAVASCRIPTS
jQuery( document ).ready( function(){
    jQuery( '.read-offline-field-submit .submit-confirm-container input[type=checkbox]' ).each( function( index, value ){
        jQuery( this ).closest( '.read-offline-field-submit' ).find( 'input[type=submit]' ).click( function( event ){
            var _fieldSubmit = jQuery( this ).closest( '.read-offline-field-submit' );  
            _fieldSubmit.find( '.submit-confirmation-warning' ).remove(); // previous error message
            var _confirmCheckbox = jQuery( this ).closest( '.read-offline-field-submit' ).find( '.submit-confirm-container input[type=checkbox]' );
...
JAVASCRIPTS;
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'read-offline-input-label-container' . ' read-offline-input-button-container' . ' read-offline-input-container',);
    }
    ...
    class Read_Offline_AdminPageFramework_FieldType_export extends Read_Offline_AdminPageFramework_FieldType_submit {
