...
class Read_Offline_AdminPageFramework_FieldType_import extends Read_Offline_AdminPageFramework_FieldType_submit {
...
jQuery( document ).ready( function() {
    jQuery( '.read-offline-field-import input[type=submit]' ).click( function( event ) {
        var _iFiles = jQuery( this ).closest( '.read-offline-field-import' ).find( 'input[type=file]' ).get( 0 ).files.length;
        if ( 0 === _iFiles ) {
...
JAVASCRIPT;
    ...
    protected function getStyles() {
        return ".read-offline-field-import input {margin-right: 0.5em;}.read-offline-field-import,.read-offline-field-import .read-offline-input-label-container {width: 100%;}.read-offline-field-import label,.form-table td fieldset.read-offline-fieldset .read-offline-field-import label { display: inline-block; width: auto;vertical-align: middle;}";
    }
