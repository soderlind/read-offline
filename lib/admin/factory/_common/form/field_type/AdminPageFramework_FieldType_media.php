...
class Read_Offline_Settings_AdminPageFramework_FieldType_image extends Read_Offline_Settings_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerRead_Offline_Settings_AdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Bind the event.
            var _oFieldContainer = oCloned.closest( '.read-offline-field' );
            ...
            setRead_Offline_Settings_AdminPageFrameworkImageUploader( 
 ...
 */
setRead_Offline_Settings_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfRead_Offline_Settings_AdminPageFrameworkSendToEditorImage;
...
var hfRead_Offline_Settings_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setRead_Offline_Settings_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oRead_Offline_Settings_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getRead_Offline_Settings_AdminPageFrameworkCustomMediaUploaderSelectObject() : oRead_Offline_Settings_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ? jQuery( '#' + sInputID ).closest( '.read-offline-field' ) 
                        : _oNewField;
                    _oNewField              = jQuery( this ).addRead_Offline_Settings_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oRead_Offline_Settings_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
removeInputValuesForImage = function( oElem ) {
    ...
    var _oImageInput = jQuery( oElem ).closest( '.read-offline-field' ).find( '.image-field input' );                  
    if ( _oImageInput.length <= 0 )  {
        return;
    }
...
JAVASCRIPTS;
    ...
    protected function getStyles() {
        return ".read-offline-field .image_preview {border: none; clear: both; margin-top: 0.4em;margin-bottom: 0.8em;display: block; max-width: 100%;height: auto; width: inherit;} .read-offline-field .image_preview img { display: block;height: auto; max-width: 100%;}.widget .read-offline-field .image_preview {max-width: 100%;}@media only screen and ( max-width: 1200px ) {.read-offline-field .image_preview {max-width: 600px;} } @media only screen and ( max-width: 900px ) {.read-offline-field .image_preview {max-width: 440px;}}@media only screen and ( max-width: 600px ) {.read-offline-field .image_preview {max-width: 300px;}} @media only screen and ( max-width: 480px ) {.read-offline-field .image_preview {max-width: 240px;}}@media only screen and ( min-width: 1200px ) {.read-offline-field .image_preview {max-width: 600px;}}.read-offline-field-image input {margin-right: 0.5em;vertical-align: middle;}.select_image.button.button-small,.remove_image.button.button-small{ vertical-align: middle;}.remove_image.button.button-small {margin-left: 0.2em;}@media screen and (max-width: 782px) {.read-offline-field-image input {margin: 0.5em 0.5em 0.5em 0;}}";
    }
...
jQuery( document ).ready( function(){     
    setRead_Offline_Settings_AdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='read-offline-image-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
JAVASCRIPTS;
        return "<script type='text/javascript' class='read-offline-{$sType}-remove-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
...
class Read_Offline_Settings_AdminPageFramework_FieldType_media extends Read_Offline_Settings_AdminPageFramework_FieldType_image {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerRead_Offline_Settings_AdminPageFrameworkCallbacks( {    
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            setRead_Offline_Settings_AdminPageFrameworkMediaUploader( 
    ...
    private function _getScript_MediaUploader($sReferrer) {
        ...
        if (!function_exists('wp_enqueue_media')) {
            return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setRead_Offline_Settings_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).click( function() {
                            ...
                            window.original_send_to_editor = window.send_to_editor;
                            window.send_to_editor = hfRead_Offline_Settings_AdminPageFrameworkSendToEditorMedia;
                            var fExternalSource = jQuery( this ).attr( 'data-enable_external_source' );
                            tb_show( '{$_sThickBoxTitle}', 'media-upload.php?post_id=1&amp;enable_external_source=' + fExternalSource + '&amp;referrer={$sReferrer}&amp;button_label={$_sThickBoxButtonUseThis}&amp;type=image&amp;TB_iframe=true', false );
                            return false; // do not click the button after the script by returning false.     
                        });    
                    ...
                    var hfRead_Offline_Settings_AdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
        ...
        return <<<JAVASCRIPTS
                ...
                setRead_Offline_Settings_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).click( function( e ) {
                        ...
                        // Store the original select object in a global variable
                        oRead_Offline_Settings_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getRead_Offline_Settings_AdminPageFrameworkCustomMediaUploaderSelectObject() : oRead_Offline_Settings_AdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            // Restore the original select object.
                            wp.media.view.MediaFrame.Select = oRead_Offline_Settings_AdminPageFrameworkOriginalMediaUploaderSelectObject;    
                ...
                removeInputValuesForMedia = function( oElem ) {
                    ...
                    var _oImageInput = jQuery( oElem ).closest( '.read-offline-field' ).find( '.media-field input' );                  
                    if ( _oImageInput.length <= 0 )  {
                        return;
                    }
...
jQuery( document ).ready( function(){   
    setRead_Offline_Settings_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
        return "<script type='text/javascript' class='read-offline-media-uploader-button'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>" . PHP_EOL;
    }
