...
class Read_Offline_AdminPageFramework_FieldType_image extends Read_Offline_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerRead_Offline_AdminPageFrameworkCallbacks( { 
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            setRead_Offline_AdminPageFrameworkImageUploader( 
 ...
 */
setRead_Offline_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function() {
        ...
        window.send_to_editor           = hfRead_Offline_AdminPageFrameworkSendToEditorImage;
...
var hfRead_Offline_AdminPageFrameworkSendToEditorImage = function( sRawHTML ) {
...
setRead_Offline_AdminPageFrameworkImageUploader = function( sInputID, fMultiple, fExternalSource ) {
    ...
    jQuery( '#select_image_' + sInputID ).click( function( e ) {
        ...
        oRead_Offline_AdminPageFrameworkOriginalImageUploaderSelectObject = wp.media.view.MediaFrame.Select;
        
        // Assign a custom select object
        wp.media.view.MediaFrame.Select = fExternalSource ? getRead_Offline_AdminPageFrameworkCustomMediaUploaderSelectObject() : oRead_Offline_AdminPageFrameworkOriginalImageUploaderSelectObject;
        ...
        _oCustomImageUploader.on( 'close', function() {
            ...
            if ( typeof( _oImage ) !== 'undefined'  ) {
                ...
                _oCustomImageUploader.state().get( 'selection' ).each( function( oAttachment, iIndex ) {
                    ...
                    var _oFieldContainer    = 'undefined' === typeof _oNewField 
                        ...
                        : _oNewField;
                    _oNewField              = jQuery( this ).addRead_Offline_AdminPageFrameworkRepeatableField( _oFieldContainer.attr( 'id' ) );
            ...
            wp.media.view.MediaFrame.Select = oRead_Offline_AdminPageFrameworkOriginalImageUploaderSelectObject;
...
jQuery( document ).ready( function(){     
    setRead_Offline_AdminPageFrameworkImageUploader( '{$sInputID}', 'true' === '{$_sRepeatable}', 'true' === '{$_bExternalSource}' );
});
JAVASCRIPTS;
...
JAVASCRIPTS;
    ...
    class Read_Offline_AdminPageFramework_FieldType_media extends Read_Offline_AdminPageFramework_FieldType_image {
...
jQuery( document ).ready( function(){
    ...
    jQuery().registerRead_Offline_AdminPageFrameworkCallbacks( {    
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            setRead_Offline_AdminPageFrameworkMediaUploader( 
        ...
        private function _getScript_MediaUploader($sReferrer) {
            ...
            if (!function_exists('wp_enqueue_media')) {
                return <<<JAVASCRIPTS
                     ...
                     * The fMultiple parameter does not do anything. It is there to be consistent with the one for the WordPress version 3.5 or above.
                     */
                    setRead_Offline_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                        ...
                        jQuery( '#select_media_' + sInputID ).click( function() {
                            ...
                            window.original_send_to_editor = window.send_to_editor;
                            window.send_to_editor = hfRead_Offline_AdminPageFrameworkSendToEditorMedia;
                            var fExternalSource = jQuery( this ).attr( 'data-enable_external_source' );
                            tb_show( '{$_sThickBoxTitle}', 'media-upload.php?post_id=1&amp;enable_external_source=' + fExternalSource + '&amp;referrer={$sReferrer}&amp;button_label={$_sThickBoxButtonUseThis}&amp;type=image&amp;TB_iframe=true', false );
                            return false; // do not click the button after the script by returning false.     
                        });    
                    ...
                    var hfRead_Offline_AdminPageFrameworkSendToEditorMedia = function( sRawHTML, param ) {
            ...
            return <<<JAVASCRIPTS
                ...
                setRead_Offline_AdminPageFrameworkMediaUploader = function( sInputID, fMultiple, fExternalSource ) {
                    ...
                    jQuery( '#select_media_' + sInputID ).click( function( e ) {
                        ...
                        // Store the original select object in a global variable
                        oRead_Offline_AdminPageFrameworkOriginalMediaUploaderSelectObject = wp.media.view.MediaFrame.Select;
                        
                        // Assign a custom select object.
                        wp.media.view.MediaFrame.Select = fExternalSource ? getRead_Offline_AdminPageFrameworkCustomMediaUploaderSelectObject() : oRead_Offline_AdminPageFrameworkOriginalMediaUploaderSelectObject;
                        ...
                        _oMediaUploader.on( 'close', function() {
                            ...
                            // Restore the original select object.
                            wp.media.view.MediaFrame.Select = oRead_Offline_AdminPageFrameworkOriginalMediaUploaderSelectObject;    
...
jQuery( document ).ready( function(){   
    setRead_Offline_AdminPageFrameworkMediaUploader( '{$sInputID}', 'true' === '{$_sRpeatable}', 'true' === '{$_sExternalSource}' );
});
JAVASCRIPTS;
