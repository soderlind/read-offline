...
class Read_Offline_AdminPageFramework_FieldType_checkbox extends Read_Offline_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachCheckboxOutput(array $aField, $sKey, $sLabel) {
        ...
        $_oCheckbox = new Read_Offline_AdminPageFramework_Input_checkbox($_aInputAttributes, array('save_unchecked' => $this->getElement($aField, 'save_unchecked'),));
    ...
    class Read_Offline_AdminPageFramework_FieldType_posttype extends Read_Offline_AdminPageFramework_FieldType_checkbox {
