...
class Read_Offline_Settings_AdminPageFramework_FieldType_checkbox extends Read_Offline_Settings_AdminPageFramework_FieldType {
    ...
    protected function getScripts() {
        new Read_Offline_Settings_AdminPageFramework_Form_View___Script_CheckboxSelector;
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.read-offline-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.read-offline-checkbox-label {margin-top: 0.1em;}.read-offline-field input[type='checkbox' ] {margin-right: 0.5em;} .read-offline-field-checkbox .read-offline-input-label-container {padding-right: 1em;}.read-offline-field-checkbox .read-offline-input-label-string{display: inline; }";
    }
...
class Read_Offline_Settings_AdminPageFramework_FieldType_posttype extends Read_Offline_Settings_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".read-offline-field input[type='checkbox'] {margin-right: 0.5em;} .read-offline-field-posttype .read-offline-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
