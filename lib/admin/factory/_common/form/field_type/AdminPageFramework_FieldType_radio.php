...
class Read_Offline_AdminPageFramework_FieldType_radio extends Read_Offline_AdminPageFramework_FieldType {
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        ...
        $_oRadio = new Read_Offline_AdminPageFramework_Input_radio($_aAttributes);
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.read-offline-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).prop( 'checked', false );
