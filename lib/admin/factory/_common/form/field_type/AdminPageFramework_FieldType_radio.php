...
class Read_Offline_Settings_AdminPageFramework_FieldType_radio extends Read_Offline_Settings_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".read-offline-field input[type='radio'] {margin-right: 0.5em;} .read-offline-field-radio .read-offline-input-label-container {padding-right: 1em;} .read-offline-field-radio .read-offline-input-container {display: inline;} .read-offline-field-radio .read-offline-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.read-offline-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
