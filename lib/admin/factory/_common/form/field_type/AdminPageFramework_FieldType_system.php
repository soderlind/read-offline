...
class Read_Offline_Settings_AdminPageFramework_FieldType_system extends Read_Offline_Settings_AdminPageFramework_FieldType {
    ...
    protected function getField($aField) {
        ...
        return $aField['before_label'] . "<div class='read-offline-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'read-offline-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<textarea " . $this->getAttributes($_aInputAttributes) . " >" . esc_textarea($this->_getSystemInfomation($aField['value'], $aField['data'], $aField['print_type'])) . "</textarea>" . $aField['after_input'] . "</label>" . "</div>" . $aField['after_label'];
    }
    ...
    private function _getSiteInfo() {
        global $wpdb;
        return array(__('Version', 'read-offline') => $GLOBALS['wp_version'], __('Language', 'read-offline') => $this->getSiteLanguage(), __('Memory Limit', 'read-offline') => $this->getReadableBytes($this->getNumberOfReadableSize(WP_MEMORY_LIMIT)), __('Multi-site', 'read-offline') => $this->getAOrB(is_multisite(), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Permalink Structure', 'read-offline') => get_option('permalink_structure'), __('Active Theme', 'read-offline') => $this->_getActiveThemeName(), __('Registered Post Statuses', 'read-offline') => implode(', ', get_post_stati()), 'WP_DEBUG' => $this->getAOrB($this->isDebugMode(), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), 'WP_DEBUG_LOG' => $this->getAOrB($this->isDebugLogEnabled(), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), 'WP_DEBUG_DISPLAY' => $this->getAOrB($this->isDebugDisplayEnabled(), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), __('Table Prefix', 'read-offline') => $wpdb->prefix, __('Table Prefix Length', 'read-offline') => strlen($wpdb->prefix), __('Table Prefix Status', 'read-offline') => $this->getAOrB(strlen($wpdb->prefix) > 16, $this->oMsg->get('too_long'), $this->oMsg->get('acceptable')), 'wp_remote_post()' => $this->_getWPRemotePostStatus(), 'wp_remote_get()' => $this->_getWPRemoteGetStatus(), __('Multibite String Extension', 'read-offline') => $this->getAOrB(function_exists('mb_detect_encoding'), $this->oMsg->get('enabled'), $this->oMsg->get('disabled')), __('WP_CONTENT_DIR Writeable', 'read-offline') => $this->getAOrB(is_writable(WP_CONTENT_DIR), $this->oMsg->get('yes'), $this->oMsg->get('no')), __('Active Plugins', 'read-offline') => PHP_EOL . $this->_getActivePlugins(), __('Network Active Plugins', 'read-offline') => PHP_EOL . $this->_getNetworkActivePlugins(), __('Constants', 'read-offline') => $this->_getDefinedConstants('user'),);
    }
