...
class Read_Offline_Settings_AdminPageFramework_FieldType_taxonomy extends Read_Offline_Settings_AdminPageFramework_FieldType_checkbox {
...
/* For tabs */
var enableRead_Offline_Settings_AdminPageFrameworkTabbedBox = function( nodeTabBoxContainer ) {
...
jQuery( document ).ready( function() {
    ...
    enableRead_Offline_Settings_AdminPageFrameworkTabbedBox( jQuery( '.tab-box-container' ) );
    ...
    jQuery().registerRead_Offline_Settings_AdminPageFrameworkCallbacks( {
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            // Initialize
            enableRead_Offline_Settings_AdminPageFrameworkTabbedBox( oCloned.find( '.tab-box-container' ) );
