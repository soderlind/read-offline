...
class Read_Offline_AdminPageFramework_FieldType_textarea extends Read_Offline_AdminPageFramework_FieldType {
...
jQuery( document ).ready( function(){
    ...
    var updateFoundEditors = function( oElements ) {
        ...
        oElements.each( function( iIndex ) {
            ...
            var oSettings = jQuery().getRead_Offline_AdminPageFrameworkInputOptions( oWrap.attr( 'data-id' ) );   
    ...
    jQuery().registerRead_Offline_AdminPageFrameworkCallbacks( {	
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            var _oSettings = jQuery().getRead_Offline_AdminPageFrameworkInputOptions( _oWrap.attr( 'data-id' ) );  
        ...
        saved_widget : function( oWidget ) { 
            ...
            jQuery( oWidget ).find( '.read-offline-field' ).each( function( iIndex ) {
                ...
                // Store the settings.
                jQuery().storeRead_Offline_AdminPageFrameworkInputOptions( 
                    oWrap.attr( 'data-id' ), 
                    { 
