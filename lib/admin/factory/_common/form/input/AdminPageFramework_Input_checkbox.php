...
abstract class Read_Offline_Settings_AdminPageFramework_Input_Base extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'read-offline-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'read-offline-input-label-string',),);
...
class Read_Offline_Settings_AdminPageFramework_Input_checkbox extends Read_Offline_Settings_AdminPageFramework_Input_Base {
