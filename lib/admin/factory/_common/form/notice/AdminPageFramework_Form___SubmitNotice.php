...
class Read_Offline_Settings_AdminPageFramework_Form___SubmitNotice extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    ...
    public function render() {
        new Read_Offline_Settings_AdminPageFramework_AdminNotice('');
    ...
    private function _printNotices($aNotices) {
        ...
        foreach (array_filter(( array )$aNotices, 'is_array') as $_aNotice) {
            ...
            new Read_Offline_Settings_AdminPageFramework_AdminNotice($this->getElement($_aNotice, 'sMessage'), $this->getElement($_aNotice, 'aAttributes'));
        }
    }
}
