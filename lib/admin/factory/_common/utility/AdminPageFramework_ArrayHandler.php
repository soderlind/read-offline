...
class Read_Offline_AdminPageFramework_FrameworkUtility extends Read_Offline_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = Read_Offline_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return Read_Offline_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
    }
    class Read_Offline_AdminPageFramework_ArrayHandler extends Read_Offline_AdminPageFramework_FrameworkUtility {
        public $aData = array();
