...
class Read_Offline_AdminPageFramework_AdminNotice extends Read_Offline_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        new Read_Offline_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
