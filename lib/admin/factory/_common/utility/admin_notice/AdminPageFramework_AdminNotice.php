...
class Read_Offline_Settings_AdminPageFramework_AdminNotice extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'read-offline-settings-notice-message', 'read-offline-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new Read_Offline_Settings_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
