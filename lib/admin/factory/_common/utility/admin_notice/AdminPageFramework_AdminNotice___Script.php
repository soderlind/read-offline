...
class Read_Offline_Settings_AdminPageFramework_AdminNotice___Script extends Read_Offline_Settings_AdminPageFramework_Factory___Script_Base {
...
( function( $ ) {
    jQuery( document ).ready( function() {         
        ...
        var _oAdminNotices = jQuery( '.read-offline-settings-notice-message' );
        if ( _oAdminNotices.length ) {
            ...
            var _oContainer     = jQuery( _oAdminNotices )
                ...
                .wrap( "<div class='read-offline-admin-notice-animation-container'></div>" );
