...
class Read_Offline_Settings_AdminPageFramework_Debug_Base extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
...
class Read_Offline_Settings_AdminPageFramework_Debug_Log extends Read_Offline_Settings_AdminPageFramework_Debug_Base {
...
class Read_Offline_Settings_AdminPageFramework_Debug extends Read_Offline_Settings_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('Read_Offline_Settings_AdminPageFramework_Debug::' . __FUNCTION__, 'Read_Offline_Settings_AdminPageFramework_Debug::dump()');
        Read_Offline_Settings_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('Read_Offline_Settings_AdminPageFramework_Debug::' . __FUNCTION__, 'Read_Offline_Settings_AdminPageFramework_Debug::get()');
        return Read_Offline_Settings_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('Read_Offline_Settings_AdminPageFramework_Debug::' . __FUNCTION__, 'Read_Offline_Settings_AdminPageFramework_Debug::log()');
        Read_Offline_Settings_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('Read_Offline_Settings_AdminPageFramework_Debug::' . __FUNCTION__);
