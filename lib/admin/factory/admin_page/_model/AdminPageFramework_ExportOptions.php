...
abstract class Read_Offline_AdminPageFramework_CustomSubmitFields extends Read_Offline_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
    ...
    class Read_Offline_AdminPageFramework_ExportOptions extends Read_Offline_AdminPageFramework_CustomSubmitFields {
        public $sClassName;
        public $sFileName;
        public $sFormatType;
        public $bIsDataSet;
            ...
            switch (strtolower($sFormatType)) {
                case 'text':
                    if (in_array(gettype($vData), array('array', 'object'))) {
                        echo Read_Offline_AdminPageFramework_Debug::get($vData, null, false);
                    }
                    echo $vData;
                    return;
                case 'json':
