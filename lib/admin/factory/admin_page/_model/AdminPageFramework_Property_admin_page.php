...
class Read_Offline_AdminPageFramework_Property_admin_page extends Read_Offline_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'read-offline') {
        ...
        $GLOBALS['aRead_Offline_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aRead_Offline_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aRead_Offline_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
