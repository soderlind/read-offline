...
class Read_Offline_Settings_AdminPageFramework_Model_Menu__RegisterMenu extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems() {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new Read_Offline_Settings_AdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
