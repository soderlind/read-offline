...
class Read_Offline_AdminPageFramework_Model__FormEmailHandler extends Read_Offline_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToSendFormEmail() {
        ...
        $_oEmail = new Read_Offline_AdminPageFramework_FormEmail($_aFormEmail['email_options'], $_aFormEmail['input'], $_aFormEmail['section_id']);
        $_bSent = $_oEmail->send();
        exit;
    }
    }
