...
abstract class Read_Offline_AdminPageFramework_Model__FormSubmission_Base extends Read_Offline_AdminPageFramework_Form_Utility {
    ...
    class Read_Offline_AdminPageFramework_Model__FormSubmission extends Read_Offline_AdminPageFramework_Model__FormSubmission_Base {
        public $oFactory;
        public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
            $this->oFactory = $oFactory;
            $this->_handleFormData();
            new Read_Offline_AdminPageFramework_Model__FormRedirectHandler($oFactory);
        }
        public function _handleFormData() {
            ...
            new Read_Offline_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
