...
class Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator_Base extends Read_Offline_Settings_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator extends Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValiateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Link', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Import', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Export', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
