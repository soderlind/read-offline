...
class Read_Offline_AdminPageFramework_Model__FormSubmission__Validator__Import extends Read_Offline_AdminPageFramework_Model__FormSubmission__Validator_Base {
    ...
    private function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new Read_Offline_AdminPageFramework_ImportOptions($this->getHTTPRequestSanitized($_FILES['__import'], false), $this->getHTTPRequestSanitized($_POST['__import'], true));
    ...
    class Read_Offline_AdminPageFramework_Model__FormSubmission__Validator__Export extends Read_Offline_AdminPageFramework_Model__FormSubmission__Validator__Import {
        public $sActionHookPrefix = 'try_validation_after_';
        ...
        protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
            $_oExport = new Read_Offline_AdminPageFramework_ExportOptions($this->getHTTPRequestSanitized($this->getElementAsArray($_POST, array('__export')), true), $this->oFactory->oProp->sClassName);
