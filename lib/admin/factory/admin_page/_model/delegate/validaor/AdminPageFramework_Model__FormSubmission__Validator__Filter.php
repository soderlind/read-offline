...
class Read_Offline_Settings_AdminPageFramework_Model__FormSubmission__Validator__Filter extends Read_Offline_Settings_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
