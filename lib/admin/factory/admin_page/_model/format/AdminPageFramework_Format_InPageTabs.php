...
class Read_Offline_Settings_AdminPageFramework_Format_InPageTabs extends Read_Offline_Settings_AdminPageFramework_Format_Base {
    ...
    public function get() {
        ...
        foreach (( array )$_aInPageTabs as $_sTabSlug => $_aInPageTab) {
            ...
            $_oFormatter = new Read_Offline_Settings_AdminPageFramework_Format_InPageTab($_aInPageTab, $this->sPageSlug, $this->oFactory);
