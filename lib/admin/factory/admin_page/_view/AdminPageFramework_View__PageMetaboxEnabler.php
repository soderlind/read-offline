...
class Read_Offline_AdminPageFramework_View__PageMetaboxEnabler extends Read_Offline_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _isMetaBoxAdded() {
        $_aPageMetaBoxClasses = $this->getElementAsArray($GLOBALS, array('aRead_Offline_AdminPageFramework', 'aMetaBoxForPagesClasses'));
    ...
    public function _replyToAddMetaboxScript() {
        $_bLoaded = $this->getElement($GLOBALS, array('aRead_Offline_AdminPageFramework', 'bAddedMetaBoxScript'), false);
        if ($_bLoaded) {
            return;
        }
        $GLOBALS['aRead_Offline_AdminPageFramework']['bAddedMetaBoxScript'] = true;
