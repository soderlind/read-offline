...
class Read_Offline_AdminPageFramework_View__PageRenderer extends Read_Offline_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    public $sPageSlug;
    public $sTabSlug;
    ...
    private function _getContentTop() {
        $_oScreenIcon = new Read_Offline_AdminPageFramework_View__PageRenderer__ScreenIcon($this->oFactory, $this->sPageSlug, $this->sTabSlug);
        $_sContentTop = $_oScreenIcon->get();
        $_oPageHeadingTabs = new Read_Offline_AdminPageFramework_View__PageRenderer__PageHeadingTabs($this->oFactory, $this->sPageSlug);
        $_sContentTop.= $_oPageHeadingTabs->get();
        $_oInPageTabs = new Read_Offline_AdminPageFramework_View__PageRenderer__InPageTabs($this->oFactory, $this->sPageSlug);
    ...
    private function _printPageMetaBoxes() {
        $_oPageMetaBoxRenderer = new Read_Offline_AdminPageFramework_View__PageMataBoxRenderer();
