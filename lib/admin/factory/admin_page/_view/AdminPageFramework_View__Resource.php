...
class Read_Offline_Settings_AdminPageFramework_View__Resource extends Read_Offline_Settings_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    private function _enqueueAsset_style($asPageStyle) {
        $_oFormatter = new Read_Offline_Settings_AdminPageFramework_Format_PageResource_Style($asPageStyle);
    ...
    private function _enqueueAsset_script($asPageScript) {
        $_oFormatter = new Read_Offline_Settings_AdminPageFramework_Format_PageResource_Script($asPageScript);
