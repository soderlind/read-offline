...
abstract class Read_Offline_Settings_AdminPageFramework_MetaBox_Router extends Read_Offline_Settings_AdminPageFramework_Factory {
...
abstract class Read_Offline_Settings_AdminPageFramework_MetaBox_Model extends Read_Offline_Settings_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'read-offline') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new Read_Offline_Settings_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class Read_Offline_Settings_AdminPageFramework_MetaBox_View extends Read_Offline_Settings_AdminPageFramework_MetaBox_Model {
...
abstract class Read_Offline_Settings_AdminPageFramework_MetaBox_Controller extends Read_Offline_Settings_AdminPageFramework_MetaBox_View {
...
abstract class Read_Offline_Settings_AdminPageFramework_MetaBox extends Read_Offline_Settings_AdminPageFramework_MetaBox_Controller {
