...
class Read_Offline_Settings_AdminPageFramework_Form_post_meta_box extends Read_Offline_Settings_AdminPageFramework_Form_Meta {
    public $sStructureType = 'post_meta_box';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new Read_Offline_Settings_AdminPageFramework_Form_View___CSS_meta_box;
