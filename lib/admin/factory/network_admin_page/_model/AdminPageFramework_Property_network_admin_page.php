...
class Read_Offline_AdminPageFramework_Property_network_admin_page extends Read_Offline_AdminPageFramework_Property_admin_page {
    ...
    protected function _getOptions() {
        return $this->addAndApplyFilter($this->getElement($GLOBALS, array('aRead_Offline_AdminPageFramework', 'aPageClasses', $this->sClassName)), 'options_' . $this->sClassName, $this->sOptionKey ? get_site_option($this->sOptionKey, array()) : array());
    }
