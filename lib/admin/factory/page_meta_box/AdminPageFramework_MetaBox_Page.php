...
abstract class Read_Offline_Settings_AdminPageFramework_MetaBox_Page extends Read_Offline_Settings_AdminPageFramework_PageMetaBox {
    public function __construct($sMetaBoxID, $sTitle, $asPageSlugs = array(), $sContext = 'normal', $sPriority = 'default', $sCapability = 'manage_options', $sTextDomain = 'read-offline') {
        ...
        $this->oUtil->showDeprecationNotice('The class, ' . __CLASS__ . ',', 'Read_Offline_Settings_AdminPageFramework_PageMetaBox');
    }
}
