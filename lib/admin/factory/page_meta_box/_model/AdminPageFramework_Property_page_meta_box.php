...
class Read_Offline_Settings_AdminPageFramework_Property_page_meta_box extends Read_Offline_Settings_AdminPageFramework_Property_post_meta_box {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'read-offline', $sStructureType = 'page_meta_box') {
        unset($this->oAdminPage, $this->aHelpTabs);
        parent::__construct($oCaller, $sClassName, $sCapability, $sTextDomain, $sStructureType);
        $GLOBALS['aRead_Offline_Settings_AdminPageFramework']['aMetaBoxForPagesClasses'] = $this->getElementAsArray($GLOBALS, array('aRead_Offline_Settings_AdminPageFramework', 'aMetaBoxForPagesClasses'));
        $GLOBALS['aRead_Offline_Settings_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        $_aPageClasses = $this->getElementAsArray($GLOBALS, array('aRead_Offline_Settings_AdminPageFramework', 'aPageClasses'));
