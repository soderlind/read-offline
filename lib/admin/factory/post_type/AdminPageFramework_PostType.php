...
abstract class Read_Offline_AdminPageFramework_PostType_Router extends Read_Offline_AdminPageFramework_Factory {
    ...
    abstract class Read_Offline_AdminPageFramework_PostType_Model extends Read_Offline_AdminPageFramework_PostType_Router {
        public function __construct($oProp) {
            parent::__construct($oProp);
            ...
            if ($this->oProp->bIsAdmin) {
                ...
                if ($this->oProp->sCallerPath) {
                    new Read_Offline_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
                }
            }
        }
        ...
        public function _replyToRegisterPostType() {
            ...
            new Read_Offline_AdminPageFramework_PostType_Model__SubMenuOrder($this);
        }
    ...
    abstract class Read_Offline_AdminPageFramework_PostType_View extends Read_Offline_AdminPageFramework_PostType_Model {
        public function __construct($oProp) {
            parent::__construct($oProp);
            if ($this->oProp->bIsAdmin) {
    ...
    abstract class Read_Offline_AdminPageFramework_PostType_Controller extends Read_Offline_AdminPageFramework_PostType_View {
    ...
    abstract class Read_Offline_AdminPageFramework_PostType extends Read_Offline_AdminPageFramework_PostType_Controller {
        ...
        public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'read-offline') {
            ...
            $this->oProp->sPostType = Read_Offline_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
            $this->oProp->aPostTypeArgs = $aArguments;
        ...
        private function _getCallerScriptPath($sCallerPath) {
            ...
            $_sPageNow = Read_Offline_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
            if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
                return Read_Offline_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
            }
            return null;
        }
    }
