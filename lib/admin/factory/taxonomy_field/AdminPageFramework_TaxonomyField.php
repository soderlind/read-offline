...
abstract class Read_Offline_Settings_AdminPageFramework_TaxonomyField_Router extends Read_Offline_Settings_AdminPageFramework_Factory {
...
abstract class Read_Offline_Settings_AdminPageFramework_TaxonomyField_Model extends Read_Offline_Settings_AdminPageFramework_TaxonomyField_Router {
...
abstract class Read_Offline_Settings_AdminPageFramework_TaxonomyField_View extends Read_Offline_Settings_AdminPageFramework_TaxonomyField_Model {
...
abstract class Read_Offline_Settings_AdminPageFramework_TaxonomyField_Controller extends Read_Offline_Settings_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class Read_Offline_Settings_AdminPageFramework_TaxonomyField extends Read_Offline_Settings_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'read-offline') {
