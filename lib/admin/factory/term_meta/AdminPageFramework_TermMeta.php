...
abstract class Read_Offline_Settings_AdminPageFramework_TermMeta_Router extends Read_Offline_Settings_AdminPageFramework_TaxonomyField_Controller {
}
abstract class Read_Offline_Settings_AdminPageFramework_TermMeta_Model extends Read_Offline_Settings_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new Read_Offline_Settings_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class Read_Offline_Settings_AdminPageFramework_TermMeta_View extends Read_Offline_Settings_AdminPageFramework_TermMeta_Model {
...
abstract class Read_Offline_Settings_AdminPageFramework_TermMeta_Controller extends Read_Offline_Settings_AdminPageFramework_TermMeta_View {
}
abstract class Read_Offline_Settings_AdminPageFramework_TermMeta extends Read_Offline_Settings_AdminPageFramework_TermMeta_Controller {
