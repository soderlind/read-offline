...
class Read_Offline_Settings_AdminPageFramework_Form_term_meta extends Read_Offline_Settings_AdminPageFramework_Form_Meta {
    public $sStructureType = 'term_meta';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new Read_Offline_Settings_AdminPageFramework_Form_View___CSS_term_meta;
