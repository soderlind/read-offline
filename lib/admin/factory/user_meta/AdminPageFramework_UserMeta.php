...
abstract class Read_Offline_Settings_AdminPageFramework_UserMeta_Router extends Read_Offline_Settings_AdminPageFramework_Factory {
...
abstract class Read_Offline_Settings_AdminPageFramework_UserMeta_Model extends Read_Offline_Settings_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new Read_Offline_Settings_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class Read_Offline_Settings_AdminPageFramework_UserMeta_View extends Read_Offline_Settings_AdminPageFramework_UserMeta_Model {
...
abstract class Read_Offline_Settings_AdminPageFramework_UserMeta_Controller extends Read_Offline_Settings_AdminPageFramework_UserMeta_View {
...
abstract class Read_Offline_Settings_AdminPageFramework_UserMeta extends Read_Offline_Settings_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'read-offline') {
