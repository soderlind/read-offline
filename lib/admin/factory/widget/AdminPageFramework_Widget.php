...
abstract class Read_Offline_Settings_AdminPageFramework_Widget_Router extends Read_Offline_Settings_AdminPageFramework_Factory {
...
abstract class Read_Offline_Settings_AdminPageFramework_Widget_Model extends Read_Offline_Settings_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new Read_Offline_Settings_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class Read_Offline_Settings_AdminPageFramework_Widget_View extends Read_Offline_Settings_AdminPageFramework_Widget_Model {
...
abstract class Read_Offline_Settings_AdminPageFramework_Widget_Controller extends Read_Offline_Settings_AdminPageFramework_Widget_View {
...
abstract class Read_Offline_Settings_AdminPageFramework_Widget extends Read_Offline_Settings_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'read-offline') {
