...
class Read_Offline_Settings_AdminPageFramework_Form_widget extends Read_Offline_Settings_AdminPageFramework_Form {
    public $sStructureType = 'widget';
    public function construct() {
        $this->_addDefaultResources();
    }
    private function _addDefaultResources() {
        $_oCSS = new Read_Offline_Settings_AdminPageFramework_Form_View___CSS_widget;
