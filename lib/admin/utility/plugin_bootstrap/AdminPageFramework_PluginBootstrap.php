...
abstract class Read_Offline_Settings_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('Read_Offline_Settings_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new Read_Offline_Settings_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
