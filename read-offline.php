...
function read_offline_admin_notice_php_version() {
	...
	$msg[] = '<strong>Read Offline</strong>: Your current PHP version is <strong>' . PHP_VERSION . '</strong>, please upgarde PHP at least to version 5.6 (PHP 7.0 or greater is reccomended). ';
...
function read_offline_admin_notice_php_warning() {
	...
	$msg[] = '<strong>Read Offline</strong>: Your current PHP version is ' . PHP_VERSION . '. <strong>Read Offline</strong> runs best on PHP 7.0 or greater.';
	$msg[] = '<a href="https://wordpress.org/about/requirements/">Ask</a> your hosting provider for an upgrade';
	$msg[] = '</p></div>';
	echo implode( PHP_EOL, $msg );
}
